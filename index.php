...
<html lang="en">
  <head>
    ...
    <title>SB Naval Transcription Tool</title>
	 
	
</head>

	
<body style="background: radial-gradient(circle, white, #af04ce);">


<nav class="navbar navbar-expand-md bg-dark navbar-dark">
	
	<a class="navbar-brand" style="color:white;">Vanz Transcription</a>
	
  <form class="form-inline" method="post" enctype="multipart/form-data">

  			<button id="slw" type="button"  class="btn btn-dark btn-sm" style="position:absolute;left:225px;top:10px;">-</button>
			<input id="speed" type="range" class="btn btn-dark btn-sm" min="1" max="3" value="2" style="position:absolute;left:260px;top:10px;width:80px;">
			<button id="fst" type="button" class="btn btn-dark btn-sm" style="position:absolute;left:350px;top:10px;">+</button>
									
			<audio id="audio" controls style="position:absolute;left:390px;top:10px;width:500px;">
			<source src="" type="audio/mpeg">
			</audio>
					
			<button id="rew" type="button" class="btn btn-dark btn-sm" style="position:absolute;left:900px;top:10px;">&lt;&lt;</button>
			<button id="for" type="button" class="btn btn-dark btn-sm" style="position:absolute;left:950px;top:10px;">&gt;&gt;</button>	
						
			<input type="file" name="fileToUpload" id="fileToUpload" style="position:absolute;left:980px;top:10px;">
			<input type="submit" value="Upload File" name="submit" style="position:absolute;left:1200px;top:10px;">
	...
	<div id="toolBar2" class="toolbar">
		<img class="intLink" title="Clean" onclick="if(confirm('Empty textbox?')){myText.innerHTML=' '; localStorage.setItem('text', ' ');};" src="data:image/gif;base64," />
	...
	<div class="flex-container">	
		<div id="text" class="container"  contentEditable="true" spellcheck="true" onkeyup='saveValue(this)'>
		</div>
		
		<div class="div-container">
			<img src="images/vanz.jpg" id="vanz">
		</div>
